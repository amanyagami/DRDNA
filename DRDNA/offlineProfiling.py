...
def tau1processing(tau1):
    ...
    for neuron in tau1:
        ...
        tau1histtodict[neuron] = listtohistogram(tau1[neuron],1)
...
def tau2processing(tau2):
    ...
    for layer_name in tau2:
        ...
        tau2histtodict[layer_name] = listtohistogram(tau2[layer_name],2)
...
if __name__ == '__main__':
    ...
    with open('tau1.pkl', 'wb') as f:
        pickle.dump(tau1 ,f)
    with open('tau2.pkl', 'wb') as f:
        pickle.dump(tau2 ,f)
    with open('tau3.pkl', 'wb') as f:
        pickle.dump(tau3 ,f)
