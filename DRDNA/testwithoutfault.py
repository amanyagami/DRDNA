...
def test_without_fault(model, tau1, tau2, tau3):
    ...
    with open('/home/local/ASUAD/asing651/ResnetCifar10pytorchFI/NoSDCIDoutput.csv', 'w') as file:
        pass
    with open('/home/local/ASUAD/asing651/ResnetCifar10pytorchFI/NoSDCIDoutput.csv', mode='a', newline='') as file:
        ...
        for batch_idx, (inputs, targets) in enumerate(testloader):
            ...
            with open('/home/local/ASUAD/asing651/ResnetCifar10pytorchFI/NoSDCIDoutput.csv', mode='a', newline='') as file:
                ...
                for layer in LayerNames:
                    ...
                    writer.writerow([layer,TAU1[layer],TAU2[layer],TAU3[layer],prev])
                writer.writerow(["\n"])
            final_Scores += [prev]
